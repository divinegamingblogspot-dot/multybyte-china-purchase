...
async function loadVendorsFixed(){try{const r=await gateway({action:'adminVendors',token:token()});if(r?.success&&Array.isArray(r.vendors))window.vendors=r.vendors;return r}catch(e){toastSafe('Vendors failed: '+e.message)}}
